...
class SettingsPage(Basepage):
    ...
    ORGANIZATION_CANCEL_BUTTON = (By.ID, "cancelbutton_org")
    POLICY_TAB = (By.ID, "policy-settings-3")
    ADD_NEW_POLICY = (By.ID, "addnew-policy-button")
    POLICY_NAME_FIELD = (By.ID, "policyName")
    POLICY_DESCRIPTION = (
    By.XPATH, "/html/body/div/div/div[2]/div/div/div[5]/div/div[2]/div[2]/div/div/div[2]/div/div[2]/div")
    ...
    UPDATE_CATEGORY_NAME_BUTTON = (By.ID, "edit-0-button-category")
    UPDATE_CATEGORY_DELETE_ICON = (By.ID, "2delete-icon")
    UPDATE_CATEGORY_POPPER_BUTTON_2 = (By.ID, "2-delete-popper-accordian-button")
    UPDATE_CATEGORY_POPPER_BUTTON = (By.XPATH, "//button[text()='Delete']")
    DELETE_CATEGORY_BUTTON = (By.XPATH, "//button[@id='delete-2-button-category']")
    ...
    DATAPOINT_CATEGORY_CANCEL_BUTTON = (By.ID, "cancel-add-datapoint-button")
    UPDATE_DATAPOINT_CATEGORY = (By.ID, "datapoint-category-4-accordian")
    UPDATE_DATAPOINT_CATEGORY_3 = (By.ID, "datapoint-category-3-accordian")
    ADD_DATAPOINT_ATTRIBUTE_NAME_FIELD = (By.ID, "datapoint-attribute-4-input-box-id")
    ADD_DATAPOINT_ATTRIBUTE_NAME_FIELD_3 = (By.ID, "datapoint-attribute-3-input-box-id")
    ADD_DATAPOINT_ATTRIBUTE_ICON = (By.XPATH,
                                    "//div[@class='MuiCollapse-root MuiCollapse-vertical MuiCollapse-entered "
                                    "css-c4sutr']//img[@id='add-subcategories-button']")
    ADD_DATAPOINT_ATTRIBUTE_ICON_3=(By.XPATH,"//div[@class='MuiCollapse-root MuiCollapse-vertical MuiCollapse-entered "
                                             "css-c4sutr']//img[@id='add-subcategories-button']")
    DELETE_DATA_POINT_ATTRIBUTE_ICON = (By.XPATH,
                                        "//div[@class='MuiCollapse-root MuiCollapse-vertical MuiCollapse-entered "
                                        "css-c4sutr']//button[@id='delete-1-datapoint-attribute']")
    # DELETE_DATA_POINT_ATTRIBUTE_ICON=(By.ID,"delete-4-datapoint")
    EDIT_DATAPOINT_CATEGORY_NAME_FIELD_3 = (By.ID, "datapoint-3-name-input-edit")
    ...
    UPDATE_DATAPOINT_CATEGORY_EDIT_BUTTON_3 = (By.ID, "edit-3-button-datapoint")
    UPDATE_DATAPOINT_CATEGORY_UPDATE_BUTTON_3 = (By.ID, "edit-3-button-datapoint")
